...
export function Landing({ isLanding, onNameClick }) {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      <h1
        onClick={onNameClick}
        className={`cursor-pointer font-display font-medium leading-[1.1] tracking-tight transition-[font-size] duration-500 ease-[var(--ease-out)] ${
      ...
      <div
        className={`overflow-hidden transition-[max-height,opacity,margin-top] duration-500 ease-[var(--ease-out)] ${
      ...
      <Separator
        className={`w-full bg-ink/10 transition-[margin-top,opacity] duration-500 ease-[var(--ease-out)] ${
