...
export const CONTACT_LINKS = [
  {
    label: 'Email',
    value: 'nargizaskarbekkyzy@gmail.com',
    href: 'mailto:nargizaskarbekkyzy@gmail.com',
  },
  {
    label: 'GitHub',
    value: '@nargizas',
    href: 'https://github.com/nargizas',
  },
  {
    label: 'LinkedIn',
    value: 'nargiz-as',
...
export const FUN_CONTENT = {
  currently: [
    { label: 'Reading', value: 'Sense and Sensibility, Jane Austen' },
    { label: 'Listening', value: 'Thinkin bout you, Flea' },
    { label: 'Sitting in', value: 'Dortmund, DE' },
  ],
  interests: ['Movies', 'Chess','Graphic design', 'Game design'],
};
